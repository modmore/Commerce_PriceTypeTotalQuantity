...
if (!createObject('modNamespace',array(
    'name' => 'commerce_pricetypetotalquantity',
    'path' => $componentPath.'/core/components/commerce_pricetypetotalquantity/',
    'assets_path' => $componentPath.'/assets/components/commerce_pricetypetotalquantity/',
),'name', false)) {
    echo "Error creating namespace commerce_pricetypetotalquantity.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pricetypetotalquantity.core_path',
    'value' => $componentPath.'/core/components/commerce_pricetypetotalquantity/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pricetypetotalquantity',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pricetypetotalquantity.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pricetypetotalquantity.assets_path',
    'value' => $componentPath.'/assets/components/commerce_pricetypetotalquantity/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_pricetypetotalquantity',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_pricetypetotalquantity.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_pricetypetotalquantity/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_pricetypetotalquantity.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_pricetypetotalquantity',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_pricetypetotalquantity.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_pricetypetotalquantity.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_pricetypetotalquantity',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_pricetypetotalquantity.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_pricetypetotalquantity/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_pricetypetotalquantity/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce_PriceTypeTotalQuantity\\Modules\\', $modulePath);
